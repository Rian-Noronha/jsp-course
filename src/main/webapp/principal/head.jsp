...
<head>
    <title>Curso JSP - Rian Noronha</title>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="author" content="Rian de Noronha Gomes da Silva" />
      <!-- Favicon icon -->
      <link rel="icon" href="<%= request.getContextPath() %>/assets/images/favicon-16x16.png" type="image/x-icon">
    <!-- Google font-->
